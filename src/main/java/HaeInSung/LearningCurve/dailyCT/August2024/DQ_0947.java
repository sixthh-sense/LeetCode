...
public class DQ_0947 {
    ...
    public static void main(String[] args) {
        DQ_0947 dq = new DQ_0947();
        List<int[][]> testcases = new ArrayList<>();
        testcases.add(new int[][]{{0, 0}, {0, 1}, {1, 0}, {1, 2}, {2, 1}, {2, 2}});
        testcases.add(new int[][]{{0, 0}, {0, 2}, {1, 1}, {2, 0}, {2, 2}});

        for (int[][] testcase : testcases) {
            System.out.println(dq.removeStones(testcase));
        }
    }
}
